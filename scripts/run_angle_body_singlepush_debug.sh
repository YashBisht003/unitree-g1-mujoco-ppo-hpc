...
LOG="${ROOT_DIR}/logs/angle_sweep_body_singlepush_debug_${TS}.log"
JSON="${ROOT_DIR}/research/results/angle_sweep_body_singlepush_debug_${TS}.json"
CSV="${ROOT_DIR}/research/results/angle_sweep_body_singlepush_debug_${TS}.csv"

mkdir -p "${ROOT_DIR}/logs" "${ROOT_DIR}/research/results"

echo "[debug-run] log=${LOG}"
echo "[debug-run] json=${JSON}"
echo "[debug-run] csv=${CSV}"
